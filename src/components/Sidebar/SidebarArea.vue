...
// =====================
// MENÚ COMPLETO CON ICONOS ORIGINALES
// =====================
const allMenuGroups = [
  {
    name: 'INICIO',
    ...
    menuItems: [
      {
        ...
        route: '#',
        children: [
          { label: 'Mis Pacientes', route: '/ListaPacientes' },
          { label: 'Citas Medicas', route: '/ListaCitasMedicas' },
          { label: 'Constancia Medica', route: '/CertificadoMedico' },
          { label: 'Historial Clinico', route: '/HistorialClinico' }
        ]
      }
    ]
  },
    ...
    menuItems: [
      {
        ...
        route: '#',
        children: [
          { label: 'Ingreso Especialidades', route: '/Dashboard' },
          { label: 'Ingreso Doctores', route: '/Dashboard' }
        ]
      }
    ]
  }
